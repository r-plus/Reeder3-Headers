...
@class EDAMNotFoundException, EDAMNoteCollectionCounts, EDAMSystemException, EDAMUserException;
...
- (void)unsetSuccess;
- (_Bool)successIsSet;
@property(retain, nonatomic, getter=success, setter=setSuccess:) EDAMNoteCollectionCounts *success;
- (void)dealloc;
