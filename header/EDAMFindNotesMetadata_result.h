...
@class EDAMNotFoundException, EDAMNotesMetadataList, EDAMSystemException, EDAMUserException;
...
- (void)unsetSuccess;
- (_Bool)successIsSet;
@property(retain, nonatomic, getter=success, setter=setSuccess:) EDAMNotesMetadataList *success;
- (void)dealloc;
