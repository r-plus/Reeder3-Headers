...
@class EDAMNotFoundException, EDAMSyncChunk, EDAMSystemException, EDAMUserException;
...
- (void)unsetSuccess;
- (_Bool)successIsSet;
@property(retain, nonatomic, getter=success, setter=setSuccess:) EDAMSyncChunk *success;
- (void)dealloc;
