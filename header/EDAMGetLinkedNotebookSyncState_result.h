...
@class EDAMNotFoundException, EDAMSyncState, EDAMSystemException, EDAMUserException;
...
- (void)unsetSuccess;
- (_Bool)successIsSet;
@property(retain, nonatomic, getter=success, setter=setSuccess:) EDAMSyncState *success;
- (void)dealloc;
