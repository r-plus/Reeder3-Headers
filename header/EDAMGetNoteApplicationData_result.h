...
@class EDAMLazyMap, EDAMNotFoundException, EDAMSystemException, EDAMUserException;
...
- (void)unsetSuccess;
- (_Bool)successIsSet;
@property(retain, nonatomic, getter=success, setter=setSuccess:) EDAMLazyMap *success;
- (void)dealloc;
