...
@class EDAMNotFoundException, EDAMNotebook, EDAMSystemException, EDAMUserException;
...
- (void)unsetSuccess;
- (_Bool)successIsSet;
@property(retain, nonatomic, getter=success, setter=setSuccess:) EDAMNotebook *success;
- (void)dealloc;
