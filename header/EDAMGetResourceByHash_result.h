...
@class EDAMNotFoundException, EDAMResource, EDAMSystemException, EDAMUserException;
...
- (void)unsetSuccess;
- (_Bool)successIsSet;
@property(retain, nonatomic, getter=success, setter=setSuccess:) EDAMResource *success;
- (void)dealloc;
