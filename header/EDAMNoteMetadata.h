...
@class EDAMNoteAttributes, NSArray, NSString;
...
- (id)initWithGuid:(id)arg1 title:(id)arg2 contentLength:(int)arg3 created:(long long)arg4 updated:(long long)arg5 updateSequenceNum:(int)arg6 notebookGuid:(id)arg7 tagGuids:(id)arg8 attributes:(id)arg9 largestResourceMime:(id)arg10 largestResourceSize:(int)arg11;
