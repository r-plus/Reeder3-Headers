...
- (id)initWithId:(int)arg1 username:(id)arg2 email:(id)arg3 name:(id)arg4 timezone:(id)arg5 privilege:(int)arg6 created:(long long)arg7 updated:(long long)arg8 deleted:(long long)arg9 active:(_Bool)arg10 shardId:(id)arg11 attributes:(id)arg12 accounting:(id)arg13;
