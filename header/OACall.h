...
@property(readonly) __weak NSDictionary *files; // @synthesize files;
@property(readonly) __weak NSArray *parameters; // @synthesize parameters;
@property(readonly) __weak NSString *method; // @synthesize method;
@property(readonly) __weak NSURL *url; // @synthesize url;
- (void).cxx_destruct;
