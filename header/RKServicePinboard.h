...
@interface RKServicePinboard : RKServiceBaseAuthConnector
{
}
...
- (id)requestWithTarget:(id)arg1 parameters:(id)arg2 method:(id)arg3 user:(id)arg4 pass:(id)arg5 token:(id)arg6;
